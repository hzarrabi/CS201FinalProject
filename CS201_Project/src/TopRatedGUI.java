...
public class TopRatedGUI extends TopGUI{
	...
	public TopRatedGUI(LoggedInDriverGUI main, Dimension d, Dimension playerDim, Boolean isGuest)
	{
		super();
	...
	public TopRatedGUI( Dimension d, Dimension playerDim, Boolean isGuest)
	{
		super();
		try {
	...
	public void fillButtons() {
		...
		if (isGuest)
		{
			topSongs = library.getTopRatedSongs();
		}
		else
		{
			topSongs = LoggedInDriverGUI.sharedMusicLibrary.getTopRatedSongs();
		}
		songs = topSongs;
